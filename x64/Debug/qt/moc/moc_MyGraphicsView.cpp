...
QT_MOC_LITERAL(1, 15, 17), // "SendGrapViewPoint"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 1), // "x"
QT_MOC_LITERAL(4, 36, 1) // "y"

    },
    "MyGraphicsView\0SendGrapViewPoint\0\0x\0"
    "y"
};
...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SendGrapViewPoint((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyGraphicsView::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGraphicsView::SendGrapViewPoint)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGraphicsView::SendGrapViewPoint(int _t1, int _t2)
{
